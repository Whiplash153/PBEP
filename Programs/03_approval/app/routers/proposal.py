...
def delete_proposal(proposal_id, data: DeleteProposalSchema):
    session = SessionLocal()
...
def update_proposal(proposal_id, data: UpdateProposalSchema):
    session = SessionLocal()
...
def change_vote(data: VoteCreateSchema):
    session = SessionLocal()
